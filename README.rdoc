...
- Write down user stories.  Where would be a good place to document the user stories?
  - the user stories could be documented in the README file.
    1. As a Customer, I want to:
      1. view all products
      2. search for a product by name (icebox: search by category)
      3. buy a product
      4. ICEBOX:
        - view profile
        - see all orders made
    ...
    2. As a Seller, I want to:
      1. view all products
      2. search for a product by name (icebox: search by category)
      3. check inventory (count) for a particular product
      4. update product's information
      5. update product's inventory
      6. create new product
      7. ICEBOX:
        - update multiple products inventory at the same time.
        - add serial numbers or UPC codes for each product.
